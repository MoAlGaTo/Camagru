	...
	<div id="my-photos">
		...
		?>
			<div id="individualPicture">
                ...
                <div id="like-comment">
                    <img src='/Camagru/Public/Image/love_black.png' onmouseover="this.src='/Camagru/Public/Image/love.png';" onmouseout="this.src='/Camagru/Public/Image/love_black.png';" class="like">
                    <p>Commentaires</p>
                    <img src='/Camagru/Public/Image/comment_black.png' onmouseover="this.src='/Camagru/Public/Image/comment.png';" onmouseout="this.src='/Camagru/Public/Image/comment_black.png';" class="like">
                </div>
			</div>
	<?php	$start++; 
			}
