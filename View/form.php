 ...
 <?php ob_start(); ?>
    ...
    <section>
        <div id="form">
            ...
            <form method="POST" action="">
                <p class="field">
                    <label for="Nom">Nom</label><br/><input type="text" name="Nom" id="Nom" placeholder="Nom De Famille" size="35" maxlength="15">
                </p>
                <p class="field">
                    <label for="prenom">Prénom</label><br/><input type="text" name="prenom" id="prenom" placeholder="Prénom" size="35" maxlength="15">
                </p>
                <p>
